...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_34898ddb450ef953, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_34898ddb450ef953, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "excalibur.excalibur.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "excalibur.excalibur.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("excalibur/excalibur/tx.proto", fileDescriptor_34898ddb450ef953) }

var fileDescriptor_34898ddb450ef953 = []byte{
	// 318 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x49, 0xad, 0x48, 0x4e,
	0xcc, 0xc9, 0x4c, 0x2a, 0x2d, 0xd2, 0x47, 0xb0, 0x4a, 0x2a, 0xf4, 0x0a, 0x8a, 0xf2, 0x4b, 0xf2,
	...
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x72, 0xdd, 0x29, 0xa8, 0x44, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/excalibur.excalibur.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/excalibur.excalibur.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "excalibur.excalibur.Msg",
	...
	Metadata: "excalibur/excalibur/tx.proto",
}
